import { menuItemOperatorTest, menuItemAccountanTest } from "@/constants/menu"
...
export const handleOperatorAccessTest = (user) => {
    ...
    const menu = menuItemOperatorTest

    if (accounting_module) {
        menuItemAccountanTest.splice(2, 0, calls)
        return menuItemAccountanTest
    }
